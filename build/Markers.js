...
export default class extends React.Component {
  ...
  render() {
    ...
    return this.props.markers.length > 0 ? React.createElement(
      "div",
      null,
      this.props.markers.map((marker, i) => {
        ...
        let color = this.props.fromGroup ? marker[this.props.fromGroup.id] === this.props.id ? groupColor : "blue" : this.state.opts[marker[this.state.name]].color;
