...
export default class Filter extends React.Component {
  constructor(props) {
    ...
    this.handleToggle = e => {
      ...
      e.value === null ? this.props.pullData({}, this.props.myKey) : this.props.pullData({ name, value: e.value }, this.props.myKey);
    };
  ...
  render() {
    ...
    return this.props.type === "toggle" ? React.createElement(
      "div",
      { className: "toggle" },
      React.createElement(
        "label",
...
Filter.propTypes = {
  ...
  opts: Proptypes.oneOfType([Proptypes.string, Proptypes.object])
